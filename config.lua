...
repairCfg = {
	...
	--	{name="Mechanic", id=446, r=24.0, x=288.0,   y=-1730.0, z=29.0},	-- Hayes Auto, Rancho (Disabled, looks like a warehouse for the Davis branch)
		...
		{name="Mechanic", id=446, r=18.0, x=-1152.06,y=-1777.42,z=4.43},	-- Exotic Car Dealership
	...
	fixMessages = {
		...
		"You told your car about how much better ganglife was from thuglife and it sprung to life",
		"Ganglife launched and your car finally sparked from joy",
		"You slapped the roof and said time to go and it magically worked",
